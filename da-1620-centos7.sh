...
wget "https://raw.githubusercontent.com/irf1404/Directadmin/master/glibc-2.17-55.el6.x86_64.rpm"
wget "https://raw.githubusercontent.com/irf1404/Directadmin/master/glibc-common-2.17-55.el6.x86_64.rpm"
wget "https://raw.githubusercontent.com/irf1404/Directadmin/master/glibc-devel-2.17-55.el6.x86_64.rpm"
wget "https://raw.githubusercontent.com/irf1404/Directadmin/master/glibc-headers-2.17-55.el6.x86_64.rpm"
...
$WGET_PATH -O /root/${VERSION_DA}.tar.gz "https://raw.githubusercontent.com/irf1404/Directadmin/master/${VERSION_DA}.tar.gz"
...
cp /root/${VERSION_DA}.tar.gz $DA_PATH/update.tar.gz
rm -rf /root/${VERSION_DA}.tar.gz
cd $DA_PATH;
...
$BIN_DIR/wget -O $SCRIPTS_PATH/config.sh "https://raw.githubusercontent.com/irf1404/Directadmin/master/config.sh"
cd $SCRIPTS_PATH
chmod 777 config.sh
./config.sh 0
